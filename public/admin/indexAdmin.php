...
<main class="container text-center py-5" style="min-height: 80vh;">
  ...
  <section id="adminCards" class="d-flex flex-wrap justify-content-center gap-4 mt-5" style="opacity:0;">
    <div class="card shadow-lg border-0 p-4 admin-card" data-link="usuarios.php" style="width: 230px; cursor:pointer; border-radius:15px;">
      <i class="fas fa-users fa-3x mb-3 text-primary"></i>
      <h5>Usuarios</h5>
      <p class="text-muted">Gestiona los clientes registrados</p>
    </div>
    <div class="card shadow-lg border-0 p-4 admin-card" data-link="pistas.php" style="width: 230px; cursor:pointer; border-radius:15px;">
      <i class="fas fa-table-tennis-paddle-ball fa-3x mb-3 text-success"></i>
      <h5>Pistas</h5>
      <p class="text-muted">Administra las pistas del club</p>
    </div>
    <div class="card shadow-lg border-0 p-4 admin-card" data-link="reservas.php" style="width: 230px; cursor:pointer; border-radius:15px;">
