...
$pistas = PistaController::listarPorDeporte('padel');
?>
<main>
      ...
      <?php foreach ($pistas as $pista): ?>
        <div class="col-6 col-md-3">
          ...
          <div class="card-body">
            ...
            <p class="<?= $pista['disponibilidad'] ? 'text-success' : 'text-danger' ?>">
              <?= $pista['disponibilidad'] ? 'Disponible' : 'No disponible' ?>
            </p>
            <?php if ($pista['disponibilidad']): ?>
              <a href="calendario_padel.php?pista_id=<?= $pista['id_pista'] ?>" class="btn btn-success w-100">
                Reservar
              </a>
            <?php else: ?>
